...
export const SITS = [
  { id: "employment-workplace", label: "Employment & Workplace", sub: "Fired, harassed, underpaid, discrimination", color: "#4338CA", icon: "briefcase", q: "What happened at work?", dm: "mid", opts: [
    ...
    { label: "Labor-management relations", nos: "720", d: "labor relations" },
    { label: "Railway Labor Act", nos: "740", d: "railway labor" },
    { label: "Family and Medical Leave Act", nos: "751", d: "FMLA" },
    { label: "Other labor litigation", nos: "790", d: "labor litigation" },
  ]},
  { id: "personal-injury", label: "Personal Injury", sub: "Accident, medical, product, wrongful death", color: "#0052CC", icon: "heart", q: "How were you hurt?", dm: "large", opts: [
    ...
    { label: "Airplane injury", nos: "310", d: "airplane accident" },
    { label: "Assault, libel & slander", nos: "320", d: "assault libel" },
    { label: "Federal employers' liability", nos: "330", d: "FELA" },
    { label: "Marine injury", nos: "340", d: "marine injury" },
    { label: "Asbestos exposure", nos: "367", d: "asbestos exposure" },
    { label: "Asbestos personal injury product", nos: "368", d: "asbestos product liability" },
  ]},
  ...
  { id: "civil-rights", label: "Civil Rights", sub: "Police, discrimination, voting, free speech", color: "#0052CC", icon: "scale", q: "What happened?", dm: "large", opts: [
    ...
    { label: "Education - other (NOS 448)", nos: "448", d: "education other" },
    ...
    { label: "State reapportionment challenge", nos: "400", d: "state reapportionment" },
    { label: "Welfare benefits denial", nos: "444", d: "welfare denial" },
    { label: "ADA - other accommodations", nos: "446", d: "ADA accommodations" },
    { label: "Prisoner civil rights", nos: "555", d: "prisoner civil rights" },
  ]},
  { id: "money-business", label: "Money & Business", sub: "Contracts, insurance, fraud, partnership", color: "#D97706", icon: "dollar", q: "What is the issue?", dm: "mid", opts: [
    ...
    { label: "Marine contract", nos: "120", d: "marine contract" },
    { label: "Miller Act / payment bond", nos: "130", d: "miller act" },
    { label: "Negotiable instrument", nos: "140", d: "negotiable instrument" },
    { label: "Overpayment recovery", nos: "150", d: "overpayment recovery" },
    { label: "Medicare dispute", nos: "151", d: "medicare dispute" },
    { label: "Veteran benefits overpayment", nos: "153", d: "veteran overpayment" },
    { label: "Stockholders suit", nos: "160", d: "stockholders suit" },
    { label: "Product liability - contract", nos: "195", d: "contract product liability" },
    { label: "Franchise dispute", nos: "196", d: "franchise dispute" },
    { label: "Land condemnation", nos: "210", d: "land condemnation" },
    { label: "Tort - product liability", nos: "245", d: "tort product liability" },
    { label: "Real property dispute", nos: "290", d: "real property dispute" },
    { label: "Airplane product liability", nos: "315", d: "airplane product liability" },
    { label: "Marine product liability", nos: "345", d: "marine product liability" },
    { label: "Motor vehicle product liability", nos: "355", d: "motor vehicle product liability" },
    { label: "False Claims Act", nos: "375", d: "false claims act" },
    { label: "Qui Tam", nos: "376", d: "qui tam" },
    { label: "Commerce / interstate", nos: "450", d: "commerce dispute" },
    { label: "RICO / racketeering", nos: "470", d: "RICO" },
    { label: "Consumer credit", nos: "480", d: "consumer credit" },
    { label: "TCPA / robocalls", nos: "485", d: "TCPA" },
    { label: "Cable/satellite TV", nos: "490", d: "cable TV" },
    { label: "Antitrust", nos: "410", d: "antitrust" },
  ]},
  { id: "housing-property", label: "Housing & Property", sub: "Landlord, foreclosure, neighbor, HOA", color: "#059669", icon: "home", q: "What happened?", dm: "large", opts: [
    ...
    { label: "Torts to land", nos: "240", d: "torts to land" },
  ]},
  { id: "healthcare-benefits", label: "Healthcare & Benefits", sub: "Claims denied, billing, disability, ERISA", color: "#DB2777", icon: "medical", q: "What happened?", dm: "large", opts: [
    ...
    { label: "Social Security benefits", nos: "860", d: "social security benefits" },
    { label: "Social Security disability", nos: "861", d: "SSDI" },
    { label: "Black Lung benefits", nos: "862", d: "black lung" },
    { label: "SSI - Supplemental Security Income", nos: "864", d: "supplemental security" },
    { label: "Social Security IRA", nos: "865", d: "retirement account" },
    { label: "IRS Third Party", nos: "871", d: "IRS third party" },
  ]},
  ...
  { id: "government", label: "Government", sub: "Benefits, taxes, immigration, constitutional", color: "#475569", icon: "building", q: "What happened?", dm: "mid", opts: [
    ...
    { label: "Deportation / removal", nos: "460", d: "deportation" },
    { label: "Naturalization application", nos: "462", d: "naturalization" },
    { label: "Habeas corpus - alien detainee", nos: "463", d: "alien habeas corpus" },
    { label: "Other immigration action", nos: "465", d: "immigration action" },
    { label: "Bankruptcy appeal", nos: "422", d: "bankruptcy appeal" },
    { label: "Withdrawal of reference (bankruptcy)", nos: "423", d: "bankruptcy withdrawal" },
    { label: "Banks and banking", nos: "430", d: "banking" },
    { label: "Motions to vacate sentence", nos: "510", d: "motion vacate" },
    { label: "Habeas corpus - general", nos: "530", d: "habeas corpus" },
    { label: "Habeas corpus - death penalty", nos: "535", d: "death penalty habeas" },
    { label: "Mandamus and other", nos: "540", d: "mandamus" },
    { label: "Other statutory actions", nos: "890", d: "statutory action" },
    { label: "Agricultural acts", nos: "891", d: "agricultural" },
    { label: "Arbitration", nos: "896", d: "arbitration" },
    { label: "Admin Procedure Act", nos: "899", d: "APA review" },
  ]},
  ...
  { id: "defense-veterans", label: "Defense & Veterans", sub: "Selective Service, military, veteran benefits", color: "#6B7280", icon: "shield", q: "What is the issue?", dm: "mid", opts: [
    { label: "Selective Service registration", nos: "810", d: "selective service" },
    { label: "Federal Employers' Liability (FELA)", nos: "330", d: "FELA" },
    { label: "Veterans benefits denied", nos: "863", d: "veterans benefits" },
  ]},
];
