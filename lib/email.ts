        ...
        <html>
          <head>
            ...
            <style>
              ...
              .body-content a { color: #0052CC; text-decoration: none; }
              .cta-button { background-color: #E65C00; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: 600; font-size: 15px; }
