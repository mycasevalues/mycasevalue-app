        ...
        <html>
          <head>
            ...
            <style>
              ...
              .cta-button { background-color: #0966C3; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: 600; font-size: 15px; }
