...
const staticPages: Array<{ route: string; importPath: string }> = [
  ...
  { route: '/developers/widget', importPath: '../../app/developers/widget/page' },
  ...
  // /for/attorneys removed — now a permanent 301 to /attorney (see next.config.js)
  ...
  // /solutions/api and /solutions/api/widget removed — widget now at /developers/widget; /solutions/api 301s to /developers
  ...
  // /solutions/law-firms removed — 301 to /solutions/small-firms
