  ...
  if (!cases) {
    return (
      <motion.div
        ...
        className="rounded-lg border border-[#E0E0E0] bg-[var(--surf,#F6F5F2)] p-6"
      >
        ...
        <AnimatePresence>
          {cases.map((caseItem: CaseLawSummary, index: number) => (
            <motion.div
              ...
              className="border border-[#E0E0E0] rounded-lg overflow-hidden hover:border-[#E0E0E0] transition-colors"
            >
              <button
              ...
              <AnimatePresence>
                {expandedIndex === index && (
                  <motion.div
                    ...
                    className="border-t border-[#E0E0E0] bg-[var(--color-surface-2)]"
                  >
                    <div className="p-4">
