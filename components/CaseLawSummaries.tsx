    ...
    return (
      ...
      >
        ...
        <div className="text-sm text-gray-400">
          <p className="font-medium text-gray-300 mb-1">Case law analysis coming soon</p>
          <p>
        ...
        <AnimatePresence>
          {cases.map((caseItem: CaseLawSummary, index: number) => (
            <motion.div
              ...
              className="border border-white/10 rounded-lg overflow-hidden hover:border-white/10 transition-colors"
            >
              <button
