...
export default function CaseLawSummaries({ nosCode }: CaseLawSummariesProps) {
  ...
  if (!cases) {
    return (
      ...
      >
        <h2 className="text-lg font-semibold text-gray-900 mb-3">Relevant Case Law</h2>
        <div className="text-sm text-gray-600">
          <p className="font-medium text-gray-700 mb-1">Case law analysis coming soon</p>
          <p>
            Our AI case law summarizer is currently analyzing precedents for NOS {nosCode}. Check back soon
            for landmark cases and recent opinions relevant to this case type.
          </p>
        </div>
      </motion.div>
    );
  ...
  return (
    <motion.div
      ...
      className="rounded-lg border border-gray-200 bg-white p-6"
    >
      <h2 className="text-lg font-semibold text-gray-900 mb-6">Relevant Case Law</h2>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <p className="text-xs text-gray-600">
          <span className="font-semibold text-gray-700">Source:</span> CourtListener federal court opinions.
