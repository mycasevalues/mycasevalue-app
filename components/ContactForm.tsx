...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <div style={{
        padding: '48px 32px', background: 'var(--card)', border: '1px solid var(--bdr)',
        borderRadius: '4px', textAlign: 'center',
        boxShadow: 'var(--shadow-xs)',
      }}>
        <svg aria-hidden="true" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--data-positive)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '16px' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--text2)', fontFamily: 'var(--font-ui)', lineHeight: 1.6 }}>
  ...
  const inputStyle = {
    ...
    fontFamily: 'var(--font-ui)', color: 'var(--text1)',
  ...
  const labelStyle = {
    ...
    color: 'var(--text1)', fontFamily: 'var(--font-ui)',
    marginBottom: '8px',
  } as React.CSSProperties;
    ...
    <>
      <style>{`
        ...
        .contact-submit {
          ...
          background: var(--link); color: var(--card); border: none;
      ...
      <form onSubmit={handleSubmit} style={{
        padding: '32px', background: 'var(--card)', border: '1px solid var(--bdr)',
