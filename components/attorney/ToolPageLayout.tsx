          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-1">
                <h1
 className="sm: text-[var(--color-text-muted)]"
 style={{ fontFamily: 'var(--font-legal)', fontSize: 20, fontWeight: 600 }}
 >
                  {title}
                </h1>
                {requiresPro && (
                  <span
 className="inline-flex items-center px-3 py-1 rounded bg-[var(--surf)]"
 style={{ color: 'var(--link)', fontSize: 14, fontWeight: 500 }}
 >
                    Pro
                  </span>
                )}
      ...
      {requiresPro && !isAuthenticated ? (
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="rounded border border-[var(--bdr, #E5E7EB)] p-8 sm:p-12 text-center bg-[var(--color-surface-2)]">
            ...
            <a
 href="/sign-in"
 className="inline-flex items-center justify-center px-6 py-3 rounded-md text-white transition-colors bg-[var(--gold,#C4882A)] hover:bg-[var(--gold-hover,#A87222)]" style={{ fontWeight: 500 }}
 >
              Sign in
            </a>
          </div>
