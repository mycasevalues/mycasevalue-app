  ...
  return (
    <div>
      <style>{`
        ...
        .je-page-btn:hover { background: var(--color-surface-1); border-color: #004182; }
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12, marginBottom: 24 }}>
        {[
          { label: 'Judges', value: String(filtered.length), color: 'var(--color-text-primary)' },
          ...
          { label: 'Avg Duration', value: `${avgDur}mo`, color: 'var(--color-text-primary)' },
        ].map(s => (
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--color-text-primary)', margin: '0 0 2px', fontFamily: 'var(--font-display)' }}>
                      {judge.name}
                    </p>
                ...
                {/* Mini win rate bar */}
                <div style={{ marginTop: 12, height: 4, background: 'var(--color-surface-1)', borderRadius: 2, overflow: 'hidden' }}>
