...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: 'Enter your state, claim amount range, timeline, and whether you have an attorney. We match these against 4.1M+ federal case records.',
    descriptionEs: 'Ingrese su estado, rango de reclamo, tiempo y si tiene abogado. Comparamos esto contra 4.1M+ registros de casos federales.',
