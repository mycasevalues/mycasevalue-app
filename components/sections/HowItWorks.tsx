...
const STEPS: Step[] = [
  {
    ...
    description: 'Choose from 84 federal civil case categories — employment discrimination, personal injury, civil rights, contract disputes, and more.',
    descriptionEs: 'Elija entre 84 categorias de casos civiles federales — discriminacion laboral, lesiones personales, derechos civiles, disputas contractuales y mas.',
  ...
  },
  {
    ...
    description: 'Enter your state, claim amount range, timeline, and whether you have an attorney. We match these against 5.1M+ federal case records.',
    descriptionEs: 'Ingrese su estado, rango de reclamo, tiempo y si tiene abogado. Comparamos esto contra 5.1M+ registros de casos federales.',
