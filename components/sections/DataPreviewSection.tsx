        ...
        <div className="flex gap-2 mb-8 border-b border-slate-200 bg-white rounded-t-xl p-4">
          {tabs.map((tab) => (
            <button
              ...
              style={{
                color: activeTab === tab.id ? '#B8923A' : '#94A3B8',
                background: activeTab === tab.id ? '#F3EBDA' : 'transparent',
                borderBottom:
                  activeTab === tab.id ? '2px solid #B8923A' : 'none',
              }}
            >
              {tab.label}
            </button>
        ...
        {activeTab === 'winrates' && (
          <div className="bg-white p-8 rounded-b-xl shadow-sm transition-opacity duration-200 fade-in">
                    ...
                    >
                      <defs>
                        <linearGradient
                          ...
                          y2="0%"
                        >
                          <stop offset="0%" style={{ stopColor: '#B8923A', stopOpacity: 0.8 }} />
                          <stop
                            offset="100%"
                            style={{ stopColor: '#C9A54E', stopOpacity: 1 }}
                          />
                        </linearGradient>
                      </defs>
                      <rect
            ...
            <div
              ...
              style={{ background: '#F3EBDA20', borderColor: '#B8923A40' }}
            >
              {lang === 'es'
        ...
        {activeTab === 'settlements' && (
          <div className="bg-white p-8 rounded-b-xl shadow-sm transition-opacity duration-200 fade-in">
              ...
              <svg width="100%" height="280" viewBox="0 0 400 280">
                <defs>
                  <linearGradient id="settlementGrad" x1="0%" y1="100%" x2="0%" y2="0%">
                    <stop offset="0%" style={{ stopColor: '#B8923A', stopOpacity: 0.4 }} />
                    <stop offset="100%" style={{ stopColor: '#B8923A', stopOpacity: 0.8 }} />
                  </linearGradient>
                </defs>
                ...
                <line
                  ...
                  opacity="0.5"
                />
                <circle cx="150" cy="25" r="3" fill="#B8923A" />
                <text x="150" y="15" fontSize="11" fill="#B8923A" textAnchor="middle" fontWeight="600">
            ...
            <div
              ...
              style={{ background: '#F3EBDA20', borderColor: '#B8923A' }}
            >
              <div className="font-semibold mb-1" style={{ color: '#B8923A' }}>
