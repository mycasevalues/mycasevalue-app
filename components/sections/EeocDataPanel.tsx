    ...
    <div className="rounded-2xl p-6 sm:p-8" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-default)' }}>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        {[
          ...
          <div key={i} className="text-center p-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.5)', border: '1px solid var(--border-default)' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
        {/* Doughnut */}
        <div className="flex flex-col items-center p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.4)', border: '1px solid var(--border-default)' }}>
        ...
        {/* Bar chart */}
        <div className="p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.4)', border: '1px solid var(--border-default)' }}>
          <div className="text-[10px] font-bold tracking-[1.5px] uppercase mb-3" style={{ color: 'var(--fg-subtle)' }}>
        ...
        <div className="rounded-xl p-4 mb-4" style={{ background: 'rgba(17,17,17,0.05)', border: '1px solid rgba(17,17,17,0.15)' }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {EEOC_DATA.damageCaps.tiers.map((tier, i) => (
              <div key={i} className="text-center p-2 rounded-lg" style={{ background: 'rgba(255,255,255,0.5)' }}>
