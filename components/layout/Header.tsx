          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              ...
              >
                ...
                <span className="font-inter text-base font-bold text-gray-900 hidden sm:block tracking-tight">
            ...
            <div className="hidden lg:flex items-center gap-3">
              {userEmail ? (
                ...
                <>
                  ...
                  <Link
                    href="/sign-up"
                    className="px-4 py-2 rounded-full bg-brand-blue text-white text-sm font-semibold hover:bg-brand-blue-dark transition-colors"
                  >
                    Get Started
                  </Link>
                </>
