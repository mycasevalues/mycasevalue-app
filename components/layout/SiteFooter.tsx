        ...
        >
          ...
          <div>
            <div className="site-footer-logo">
              {/* Inline SVG for reliable rendering on dark background */}
              <svg viewBox="0 0 160 34" width="112" height="28" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="MyCaseValue" style={{ display: 'block', marginBottom: '12px' }}>
                <defs>
                ...
                <rect x="2" y="2" width="30" height="30" rx="4" ry="4" fill="url(#footerLogoGrad)" />
                ...
                <text x="38" y="23" fontFamily="Inter, -apple-system, BlinkMacSystemFont, sans-serif" fontSize="18" fontWeight="700" fill="#FFFFFF" letterSpacing="0.2">MyCaseValue</text>
              </svg>
            </div>
            <p style={{
