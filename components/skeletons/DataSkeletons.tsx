...
export function WinRateSkeleton() {
  return (
    <>
      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #E0DDD8', borderRadius: '8px', padding: '24px' }}>
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
        {[1, 2, 3, 4].map((i) => (
          <div key={i} style={{ background: '#FFFFFF', border: '1px solid #E0DDD8', borderRadius: '8px', padding: '20px' }}>
