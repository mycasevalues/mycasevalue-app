export default function TrustBar() {
  ...
  return (
    <div style={{
      background: '#FFFFFF', borderBottom: '1px solid #D5D8DC', padding: '24px',
    }}>
      <div style={{
        ...
        {indicators.map((item, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#E8171F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d={item.icon} />
            </svg>
            <span style={{ fontSize: '13px', fontWeight: 500, color: '#455A64', fontFamily: 'var(--font-body)' }}>
