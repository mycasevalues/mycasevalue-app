    ...
    g.selectAll('.hover-rect')
      ...
      .on('mouseenter', function (event: MouseEvent, d: { year: number; filings: number }) {
        ...
        if (tooltip) {
          ...
          tooltip.innerHTML = `<div style="font-weight: 600; color: var(--link); font-size: 14px; font-family: var(--font-mono)">${d.year}</div><div style="color: var(--text2); font-size: 12px; margin-top: 4px; font-family: var(--font-ui)">Filings: <strong>${d.filings.toLocaleString()}</strong></div>`;
