      ...
      .on('mouseenter', function (event: MouseEvent, d: { year: number; winRate: number }) {
        ...
        if (parentElement) {
          d3.select(parentElement)
            ...
            .attr('fill', (pd: any) => pd.year === d.year ? 'var(--link)' : 'var(--link)')
        ...
        if (tooltip) {
          ...
          tooltip.innerHTML = `<div style="font-weight: 600; color: var(--link); font-size: 14px; font-family: var(--font-mono)">${d.year}</div><div style="color: var(--text2); font-size: 12px; margin-top: 4px; font-family: var(--font-ui)">Win Rate: <strong style="font-family: var(--font-mono)">${d.winRate}%</strong></div>`;
