    ...
    g.selectAll('.hover-rect')
      ...
      .on('mouseenter', function (event: MouseEvent, d: { year: number; winRate: number }) {
        ...
        if (tooltip) {
          ...
          tooltip.innerHTML = `<div style="font-weight: 600; color: var(--accent-primary); font-size: 14px; font-family: var(--font-mono)">${d.year}</div><div style="color: var(--color-text-secondary); font-size: 12px; margin-top: 4px; font-family: var(--font-ui)">Win Rate: <strong style="font-family: var(--font-mono)">${d.winRate}%</strong></div>`;
