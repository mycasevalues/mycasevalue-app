...
export function HeartPulseIcon({ color = 'var(--link)', size = 24 }: { color?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" stroke={color} {...s}>
...
export function ShieldIcon({ color = 'var(--link, #1A73E8)', size = 24 }: { color?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" stroke={color} {...s}>
...
export function BuildingIcon({ color = 'var(--text2)', size = 24 }: { color?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" stroke={color} {...s}>
