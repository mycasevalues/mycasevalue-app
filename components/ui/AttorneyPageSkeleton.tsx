...
export default function AttorneyPageSkeleton({
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--surf)' }}>
      ...
      <div style={{ backgroundColor: 'var(--link)', color: 'var(--card)', padding: '32px 20px' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto' }}>
          {/* Breadcrumb */}
          <div className="skel-pulse" style={{ height: 12, width: 180, background: 'rgba(255,255,255,0.1)', borderRadius: 2, marginBottom: 20 }} />
          {/* Badge */}
          <div className="skel-pulse" style={{ height: 26, width: 120, background: 'var(--link)', borderRadius: 2, marginBottom: 16, opacity: 0.5 }} />
          {/* Title */}
            ...
            {[1, 2, 3].map(i => (
              <div
                ...
                style={{
                  height: 40,
                  width: 100,
                  background: i === 1 ? 'var(--card)' : 'var(--surf)',
                  borderTop: i === 1 ? '2px solid var(--link)' : '2px solid transparent',
          ...
          {Array.from({ length: cards }).map((_, i) => (
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ height: 18, width: '50%', background: 'var(--bdr)', borderRadius: 2 }} />
                <div style={{ height: 24, width: 60, background: 'var(--surf)', borderRadius: 2 }} />
              </div>
              {/* Card body lines */}
              ...
              <div style={{ height: 14, width: '60%', background: 'var(--surf)', borderRadius: 2, marginBottom: 16 }} />
              {/* Card footer bar */}
              <div style={{ height: 8, width: '100%', background: 'var(--surf)', borderRadius: 2 }}>
                <div style={{ height: '100%', width: `${30 + (i * 15) % 50}%`, background: 'var(--bdr)', borderRadius: 2 }} />
              </div>
            </div>
          ))}
        </div>
