    ...
    <>
      ...
      <noscript>
        <div style={{
          ...
          <div style={{ padding: '20px', textAlign: 'center', background: 'var(--color-surface-0)', border: '2px solid rgba(240, 242, 245, 0.09)', borderRadius: '4px' }}>
          ...
          <div style={{ padding: '20px', textAlign: 'center', background: 'var(--color-surface-0)', border: '2px solid rgba(109, 40, 217, 0.09)', borderRadius: '4px' }}>
