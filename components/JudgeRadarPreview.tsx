...
export default function JudgeRadarPreview() {
  return (
    <div style={{ maxWidth: 380, margin: '24px auto 0' }}>
      <div style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--color-text-muted)', textAlign: 'center', marginBottom: 8, fontFamily: 'var(--font-ui)' }}>
