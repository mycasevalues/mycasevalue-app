          ...
          <html>
            <head>
              ...
              <style>
                ...
                .cta-button { background-color: #C4882A; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: 600; font-size: 15px; margin-top: 16px; }
                ...
                .highlight { background-color: #FFF3CD; padding: 12px; border-left: 4px solid #C4882A; margin: 16px 0; }
              </style>
            </head>
            <body>
