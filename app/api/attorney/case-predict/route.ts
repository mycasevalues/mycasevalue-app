...
const CASE_PROFILES: Record<string, MockCaseProfile> = {
  'personal-injury': {
    ...
    sampleSize: 124500,
    outcomes: [
      { label: 'Settlement', percentage: 52, color: 'var(--data-positive)' },
      { label: 'Dismissed', percentage: 23, color: 'var(--data-negative)' },
      { label: 'Judgment for Plaintiff', percentage: 12, color: 'var(--link)' },
      { label: 'Judgment for Defendant', percentage: 8, color: 'var(--flag-yellow)' },
      { label: 'Trial', percentage: 5, color: 'var(--link-visited)' },
    ],
  },
  'employment-discrimination': {
    ...
    sampleSize: 89200,
    outcomes: [
      { label: 'Settlement', percentage: 38, color: 'var(--data-positive)' },
      { label: 'Dismissed', percentage: 32, color: 'var(--data-negative)' },
      { label: 'Judgment for Plaintiff', percentage: 10, color: 'var(--link)' },
      { label: 'Judgment for Defendant', percentage: 14, color: 'var(--flag-yellow)' },
      { label: 'Trial', percentage: 6, color: 'var(--link-visited)' },
    ],
  },
  'medical-malpractice': {
    ...
    sampleSize: 42800,
    outcomes: [
      { label: 'Settlement', percentage: 45, color: 'var(--data-positive)' },
      { label: 'Dismissed', percentage: 25, color: 'var(--data-negative)' },
      { label: 'Judgment for Plaintiff', percentage: 8, color: 'var(--link)' },
      { label: 'Judgment for Defendant', percentage: 15, color: 'var(--flag-yellow)' },
      { label: 'Trial', percentage: 7, color: 'var(--link-visited)' },
    ],
  },
  'breach-of-contract': {
    ...
    sampleSize: 156300,
    outcomes: [
      { label: 'Settlement', percentage: 48, color: 'var(--data-positive)' },
      { label: 'Dismissed', percentage: 20, color: 'var(--data-negative)' },
      { label: 'Judgment for Plaintiff', percentage: 15, color: 'var(--link)' },
      { label: 'Judgment for Defendant', percentage: 12, color: 'var(--flag-yellow)' },
      { label: 'Trial', percentage: 5, color: 'var(--link-visited)' },
    ],
  },
};
...
const DEFAULT_PROFILE: MockCaseProfile = {
  ...
  sampleSize: 50000,
  outcomes: [
    { label: 'Settlement', percentage: 44, color: 'var(--data-positive)' },
    { label: 'Dismissed', percentage: 26, color: 'var(--data-negative)' },
    { label: 'Judgment for Plaintiff', percentage: 12, color: 'var(--link)' },
    { label: 'Judgment for Defendant', percentage: 12, color: 'var(--flag-yellow)' },
    { label: 'Trial', percentage: 6, color: 'var(--link-visited)' },
  ],
