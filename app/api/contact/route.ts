      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header { background: #0966C3; color: white; padding: 24px; text-align: center; }
            .content { background: white; padding: 32px 24px; }
            .field { margin-bottom: 24px; }
            .label { font-weight: 600; color: #0966C3; margin-bottom: 8px; font-size: 14px; }
            .value { color: #4B5563; font-size: 15px; line-height: 1.6; }
            .message-box { background: #f3f4f6; padding: 16px; border-left: 4px solid #0966C3; border-radius: 4px; }
