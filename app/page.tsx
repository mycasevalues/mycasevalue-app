...
'               <Link href="/cases" className="inline-flex h-10 items-center px-6 bg-white text-gray-900 text-sm font-semibold rounded hover:bg-gray-100 transition-colors">
'                 Browse Cases
'               </Link>
...
'         </div>
'         <Link href="/cases" className="inline-flex h-10 items-center px-6 bg-white text-gray-900 text-sm font-semibold rounded hover:bg-gray-100 transition-colors flex-shrink-0">
'           Browse Cases
'         </Link>
'       </div>
'     </section>
