    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="border-b" style={{ borderColor: 'var(--border-default)', background: 'linear-gradient(180deg, var(--bg-surface) 0%, var(--bg-base) 100%)' }}>
        <div className="max-w-6xl mx-auto px-6 py-16 sm:py-24">
          ...
          <h1 className="text-3xl sm:text-4xl font-black mb-4" style={{ color: 'var(--accent-primary)', fontFamily: 'var(--font-display)', letterSpacing: '-1.5px' }}>
          ...
          {stateList.map((state) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--accent-secondary)" strokeWidth="2.5" className="opacity-0 group-hover:opacity-100 transition-opacity">
