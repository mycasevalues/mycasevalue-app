  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surf)' }}>
      ...
      <div style={{ maxWidth: 1140, margin: '0 auto', padding: '32px 24px' }}>
        {[1,2,3].map(i => (
          <div key={i} className="sp" style={{ background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: 2, padding: 24, marginBottom: 16, animationDelay: `${i*150}ms` }}>
            <div style={{ height: 16, width: '45%', background: 'var(--bdr)', borderRadius: 2, marginBottom: 12 }} />
            <div style={{ height: 14, width: '80%', background: 'rgba(255,255,255,0.04)', borderRadius: 2, marginBottom: 8 }} />
            <div style={{ height: 14, width: '60%', background: 'var(--surf)', borderRadius: 2 }} />
          </div>
        ))}
      </div>
    </div>
