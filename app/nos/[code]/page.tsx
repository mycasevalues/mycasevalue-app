...
export default async function NOSPage({ params }: PageProps) {
      ...
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#F7F8FA', color: '#0f0f0f' }}>
        <div className="text-center">
          ...
          <Link href="/" className="inline-block px-6 py-3 font-semibold text-white transition"
            style={{ background: '#0A66C2', borderRadius: '12px' }}>
            Return to Home
          </Link>
        </div>
      </div>
  ...
  const outcomePercentages = real?.ends
    ...
    : [
        ...
        { label: 'Trial Win', value: outcomeData.trial_win || 10, color: '#004182' },
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: 'var(--font-body)', background: '#F7F8FA', color: '#4B5563' }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-start justify-between gap-6" style={{ flexWrap: 'wrap' }}>
            <div className="flex-1">
              <h1 style={{ fontSize: 'clamp(28px, 6vw, 36px)', fontWeight: 600, margin: '0 0 12px 0', fontFamily: 'var(--font-display)', lineHeight: 1.2, color: '#FFFFFF' }}>
                {nosInfo.label}
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Cases Analyzed', value: totalCases > 0 ? totalCases.toLocaleString() : '500+', color: '#004182', showSample: false },
            ].map((stat, i) => (
          ...
          <div className="content-box">
            ...
            <div className="outcome-dist-labels">
              <div className="outcome-dist-label">
                <div className="outcome-dist-dot" style={{ background: '#059669' }}></div>
            ...
            <div className="content-box">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', textAlign: 'center', marginTop: '28px' }}>
                <div>
                  ...
                  <div style={{ fontSize: '24px', fontWeight: 600, color: '#004182', fontFamily: 'var(--font-mono)' }}>{fmtK(recoveryRange.lo)}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '24px', fontWeight: 600, color: '#004182', fontFamily: 'var(--font-mono)' }}>{fmtK(recoveryRange.hi)}</div>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div key={circuit} style={{
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                          ...
                          <span style={{
                            fontSize: '14px',
                            fontWeight: 600,
                            color: wr >= winRate ? '#059669' : '#0A66C2',
                            fontFamily: 'var(--font-mono)',
                          }}>
                            {wr}%
                          </span>
                        </div>
                        <div style={{ height: '4px', background: '#E5E7EB', borderRadius: '12px', overflow: 'hidden' }}>
                          <div style={{
                            height: '100%',
                            width: `${Math.min(wr, 100)}%`,
                            background: wr >= winRate ? '#059669' : '#0A66C2',
                            borderRadius: '12px',
                          }} />
                        </div>
                      </div>
                  ...
                  <Link key={caseType.code} href={`/nos/${caseType.code}`} className="related-type-card">
                    ...
                    <div className="related-type-stats">
                      <div className="related-type-stat">
                        <span>Win Rate:</span>
                        <strong style={{ color: caseType.wr >= 50 ? '#059669' : '#0A66C2' }}>{caseType.wr}%</strong>
                      </div>
                      <div className="related-type-stat">
                        <span>Settlement:</span>
                        <strong style={{ color: '#004182' }}>{caseType.sp}%</strong>
                      </div>
                      <div className="related-type-stat">
                        <span>Cases:</span>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 text-center" style={{ background: '#FFFFFF', borderTop: '1px solid #E5E7EB' }}>
        <div className="max-w-6xl mx-auto">
          <h2 style={{ fontSize: '28px', fontWeight: 600, margin: '0 0 12px 0', color: '#0f0f0f', fontFamily: 'var(--font-display)' }}>
