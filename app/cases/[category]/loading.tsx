    ...
    <div style={{ minHeight: '100vh', background: '#F7F8FA', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ background: '#1B3A5C', padding: '48px 24px', borderBottom: '3px solid #0A66C2' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ height: '18px', width: '60%', background: 'rgba(255,255,255,0.08)', borderRadius: '12px' }} />
        </div>
      </div>
        ...
        <div style={{
          ...
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} style={{
              ...
              <div style={{ height: '24px', width: '80%', background: '#E5E7EB', borderRadius: '12px', marginBottom: '12px' }} />
