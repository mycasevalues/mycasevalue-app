    ...
    <div style={{ minHeight: '100vh', background: bgColor, fontFamily: 'var(--font-ui)', color: textColor }}>
      ...
      <div style={{ background: 'var(--card)', padding: '40px 24px 32px', borderBottom: `1px solid ${borderColor}` }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '28px', fontWeight: 700, margin: '0 0 16px 0', color: 'var(--color-text-primary)', fontFamily: 'var(--font-ui)', letterSpacing: '-0.02em' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <section style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: '24px', color: 'var(--color-text-primary)', fontFamily: 'var(--font-ui)' }}>
                  ...
                  {RECENT_SETTLEMENTS.map((settlement, i) => (
                    <tr key={i} style={{ borderBottom: i < RECENT_SETTLEMENTS.length - 1 ? `1px solid ${borderColor}` : 'none' }}>
                      ...
                      <td style={{ padding: '12px 16px' }}>
                        <span style={{ background: 'rgba(59,130,246,0.08)', color: secondaryColor, padding: '4px 8px', borderRadius: '3px', fontSize: '12px', fontWeight: 500 }}>
