    ...
    <div style={{ background: 'var(--color-surface-1)', minHeight: '100vh', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1080px', margin: '0 auto', position: 'relative' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-inter)', fontSize: 'clamp(24px, 3.5vw, 30px)', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.1, color: '#FFF', margin: '0 0 12px' }}>Know your reversal odds before you file</h1>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: showResult && data ? '380px 1fr' : '1fr', gap: '24px' }}>
          ...
          {showResult && data && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {/* Appeal Probability */}
              <div style={{ background: 'var(--color-surface-0)', borderRadius: '12px', padding: '32px', border: '1px solid var(--border-default)', textAlign: 'center' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div style={{ background: 'var(--color-surface-0)', borderRadius: '12px', padding: '24px', border: '1px solid var(--border-default)', textAlign: 'center' }}>
              ...
              <div style={{ background: 'rgba(59,130,246,0.08)', borderRadius: '12px', padding: '20px', border: '1px solid var(--accent-primary)' }}>
