...
export default function AppealsPage() {
  ...
  return (
    <div style={{ background: 'var(--surf)', minHeight: '100vh', fontFamily: 'var(--font-ui)' }}>
      <style>{`select:focus, input:focus { outline: none; border-color: var(--link); box-shadow: var(--shadow-focus); }`}</style>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1080px', margin: '0 auto', position: 'relative' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-legal)', fontSize: '28px', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.1, color: 'var(--text1)', margin: '0 0 12px' }}>Know Your Reversal Odds Before You File</h1>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: showResult && data ? '380px 1fr' : '1fr', gap: '24px' }}>
          ...
          <div style={{ background: 'var(--card)', borderRadius: '4px', padding: '32px', border: '1px solid var(--bdr)' }}>
            <h2 style={{ fontSize: '20px', fontWeight: 600, color: 'var(--text1)', margin: '0 0 24px', fontFamily: 'var(--font-ui)' }}>Case Information</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: 'var(--text1)', marginBottom: '6px' }}>Case Category</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: 'var(--text1)', marginBottom: '6px' }}>District (optional)</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: 'var(--text1)', marginBottom: '6px' }}>Trial Outcome *</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: 'var(--text1)', marginBottom: '6px' }}>Months Since Judgment (optional)</label>
          ...
          {showResult && data && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ background: 'var(--card)', borderRadius: '4px', padding: '32px', border: '1px solid var(--bdr)', textAlign: 'center' }}>
                <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text2)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>Probability of Appeal</div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div style={{ background: 'var(--card)', borderRadius: '4px', padding: '24px', border: '1px solid var(--bdr)', textAlign: 'center' }}>
                  <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text2)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 6 }}>Reversal Rate</div>
                  <div style={{ fontSize: '28px', fontWeight: 600, color: getWinRateColor(reversalProb).text, fontFamily: 'var(--font-mono)' }}>
                    {reversalProb}%
                  </div>
                  <div style={{ fontSize: '12px', color: 'var(--text2)', marginTop: 4 }}>of appeals in this circuit</div>
                </div>
                <div style={{ background: 'var(--card)', borderRadius: '4px', padding: '24px', border: '1px solid var(--bdr)', textAlign: 'center' }}>
                  <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text2)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 6 }}>Average Appeal Duration</div>
                  <div style={{ fontSize: '28px', fontWeight: 600, color: 'var(--link)', fontFamily: 'var(--font-mono)' }}>
                    {data.avgDuration}
                  </div>
                  <div style={{ fontSize: '12px', color: 'var(--text2)', marginTop: 4 }}>months to resolution</div>
                </div>
              </div>

              {/* Common Grounds for Reversal */}
              <div style={{ background: 'var(--card)', borderRadius: '4px', padding: '32px', border: '1px solid var(--bdr)' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: 'var(--text1)', margin: '0 0 16px', fontFamily: 'var(--font-ui)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {grounds.map((g, i) => (
                    <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                      ...
                      <span style={{ fontSize: '14px', color: 'var(--text1)', lineHeight: 1.5 }}>{g}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div style={{ background: 'rgba(59,130,246,0.08)', borderRadius: '4px', padding: '24px', border: '1px solid var(--link)' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: 'var(--gold)', margin: '0 0 16px', fontFamily: 'var(--font-ui)' }}>Appeal Filing Deadline</h3>
                <p style={{ fontSize: '14px', color: 'var(--gold)', margin: 0, lineHeight: 1.6 }}>
        ...
        <div style={{ marginTop: '40px', paddingTop: '24px', borderTop: '1px solid var(--bdr)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px' }}>
          <Link href="/attorney/negotiation" style={{ textDecoration: 'none' }}>
            <div style={{ padding: '16px', background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: '4px' }}>
              <p style={{ fontSize: '14px', fontWeight: 600, color: 'var(--text1)', margin: '0 0 4px' }}>Negotiation Prep</p>
              <p style={{ fontSize: '12px', color: 'var(--text2)', margin: 0 }}>Settlement strategy</p>
            </div>
          </Link>
          ...
          <Link href="/attorney/demand-letter" style={{ textDecoration: 'none' }}>
            <div style={{ padding: '16px', background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: '4px' }}>
              ...
              <p style={{ fontSize: '12px', color: 'var(--text2)', margin: 0 }}>Generate letters</p>
            </div>
          </Link>
        </div>
      </div>
