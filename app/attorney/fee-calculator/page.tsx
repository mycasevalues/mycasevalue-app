      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '40px 24px' }}>
            ...
            <form onSubmit={handleCalculate} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        padding: '12px 14px',
                        borderRadius: '12px',
                        border: `1px solid ${feeArrangement === opt.val ? '#8B5CF6' : '#E5E7EB'}`,
                        backgroundColor: feeArrangement === opt.val ? 'rgba(139, 92, 246, 0.08)' : '#FAFBFC',
                        color: feeArrangement === opt.val ? '#8B5CF6' : '#4B5563',
                        fontSize: '13px',
                        fontWeight: 600,
                        cursor: 'pointer',
                        transition: 'all 0.2s',
                    ...
                    >
                      <div style={{ fontWeight: 600, color: feeArrangement === opt.val ? '#8B5CF6' : '#0f0f0f' }}>
                        {opt.label}
                      </div>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  padding: '14px',
                  backgroundColor: loading || !caseType || !caseValue ? '#E5E7EB' : '#8B5CF6',
                  color: '#FFFFFF',
                  border: 'none',
                  borderRadius: '8px',
                  fontSize: '15px',
          ...
          {feeData && showComparison && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {feeArrangement === 'contingency' && (
                <div style={cardStyle}>
                  <h3 style={{ fontSize: '15px', fontWeight: 600, color: '#0f0f0f', margin: '0 0 16px', fontFamily: 'var(--font-display)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <div style={{ padding: '12px', background: '#F0F9FF', borderRadius: '8px', border: '1px solid #E0F2FE' }}>
                      ...
                      <div style={{ fontSize: '18px', fontWeight: 700, color: '#8B5CF6', fontFamily: 'var(--font-mono)' }}>
                ...
                <div style={cardStyle}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <div style={{ padding: '12px', background: '#F0F9FF', borderRadius: '8px', border: '1px solid #E0F2FE' }}>
                      ...
                      <div style={{ fontSize: '16px', fontWeight: 700, color: '#8B5CF6', fontFamily: 'var(--font-mono)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                      <div style={{ padding: '12px', background: '#F0F9FF', borderRadius: '8px', border: '1px solid #E0F2FE' }}>
                        ...
                        <div style={{ fontSize: '14px', fontWeight: 700, color: '#8B5CF6', marginTop: '6px' }}>
        ...
        {feeData && showComparison && (
          <div style={{ marginTop: '32px', ...cardStyle }}>
            <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#0f0f0f', margin: '0 0 20px', fontFamily: 'var(--font-display)' }}>
              ...
              <table style={{
                ...
                <thead>
                  <tr style={{ borderBottom: '2px solid #E5E7EB' }}>
                    <th style={{ textAlign: 'left', padding: '12px 8px', fontWeight: 600, color: '#0f0f0f' }}>
                      Fee Type
                    </th>
                    <th style={{ textAlign: 'right', padding: '12px 8px', fontWeight: 600, color: '#0f0f0f' }}>
                      Attorney Fee
                    </th>
                    <th style={{ textAlign: 'right', padding: '12px 8px', fontWeight: 600, color: '#0f0f0f' }}>
                      Client Net
                    </th>
                    <th style={{ textAlign: 'center', padding: '12px 8px', fontWeight: 600, color: '#0f0f0f' }}>
                      Best For
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #E5E7EB', background: '#F9FAFB' }}>
                    <td style={{ padding: '12px 8px', fontWeight: 600, color: '#0f0f0f' }}>
                      25% Contingency
                    </td>
                    <td style={{ textAlign: 'right', padding: '12px 8px', color: '#0f0f0f', fontFamily: 'var(--font-mono)' }}>
                      ${feeData.contingency25.toLocaleString()}
                    </td>
                    <td style={{ textAlign: 'right', padding: '12px 8px', color: '#0f0f0f', fontFamily: 'var(--font-mono)' }}>
                      ${(parseInt(caseValue) - feeData.contingency25).toLocaleString()}
                    </td>
                    <td style={{ textAlign: 'center', padding: '12px 8px', color: '#4B5563' }}>
                      Strong cases
                    </td>
                  </tr>
