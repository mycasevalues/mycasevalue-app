  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F8FA', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 20px' }}>
        {/* API Key */}
        <div style={{ background: '#FFFFFF', borderRadius: '2px', padding: '24px', border: '1px solid #E5E7EB', marginBottom: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          <h2 className="font-display" style={{ fontSize: '16px', fontWeight: 700, color: '#212529', margin: '0 0 12px' }}>Your API Key</h2>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <div style={{ flex: 1, padding: '12px 14px', backgroundColor: '#F8F9FA', borderRadius: '2px', border: '1px solid #E5E7EB', fontFamily: 'var(--font-mono)', fontSize: '14px', color: '#212529', letterSpacing: '0.5px' }}>
              {apiKey}
            </div>
            <button onClick={copyKey} style={{ padding: '12px 20px', backgroundColor: copied ? '#07CA6B' : '#7C3AED', color: '#FFFFFF', border: 'none', borderRadius: '2px', fontSize: '12px', fontWeight: 700, cursor: 'pointer', transition: 'background-color 0.2s', minWidth: '80px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
              {copied ? 'Copied!' : 'Copy'}
            </button>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '12px', marginBottom: '24px' }}>
          {[
            ...
            <div key={s.label} style={{ background: '#FFFFFF', borderRadius: '2px', padding: '20px', border: '1px solid #E5E7EB', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
        ...
        {/* Endpoints */}
        <div style={{ background: '#FFFFFF', borderRadius: '2px', border: '1px solid #E5E7EB', overflow: 'hidden', marginBottom: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
        ...
        {/* Code Example */}
        <div style={{ background: '#FFFFFF', borderRadius: '2px', border: '1px solid #E5E7EB', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          <div style={{ padding: '16px 24px', borderBottom: '1px solid #E5E7EB', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '11px', color: '#4B5563', fontWeight: 600, padding: '3px 10px', borderRadius: '2px', backgroundColor: '#F8F9FA' }}>JavaScript</span>
          </div>
