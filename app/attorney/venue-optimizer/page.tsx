      ...
      <div style={{ background: '#00172E', borderBottom: '1px solid #D5D8DC', padding: '32px 20px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <Link href="/attorney" style={{ fontSize: '13px', color: '#E8171F', textDecoration: 'none', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '4px', marginBottom: '16px' }}>
            ...
            Home &gt; Attorney Mode &gt; Venue Optimizer
          </Link>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 20px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
            <div style={{ flex: '1 1 300px' }}>
              ...
              <select
                ...
                style={{ width: '100%', padding: '12px 14px', height: '48px', border: '1px solid #D5D8DC', borderRadius: '4px', fontSize: '14px', color: '#212529', background: '#FFFFFF', fontFamily: 'var(--font-body)', transition: 'border-color 0.2s' }}
              >
        ...
        {data && !loading && (
          <>
            ...
            <div style={{ background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.10)', borderRadius: '4px', overflow: 'hidden' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '50px 1fr 90px 90px 80px 80px 70px', gap: '8px', padding: '12px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)', backgroundColor: 'rgba(255,255,255,0.04)' }}>
                ...
                <span style={{ fontSize: '11px', fontWeight: 700, color: '#455A64', textTransform: 'uppercase' as const, textAlign: 'right' }}>Settlement</span>
                <span style={{ fontSize: '11px', fontWeight: 700, color: '#455A64', textTransform: 'uppercase' as const, textAlign: 'right' }}>Duration</span>
                <span style={{ fontSize: '11px', fontWeight: 700, color: '#455A64', textTransform: 'uppercase' as const, textAlign: 'right' }}>Advantage</span>
                <span style={{ fontSize: '11px', fontWeight: 700, color: '#455A64', textTransform: 'uppercase' as const, textAlign: 'right' }}>Score</span>
              </div>
              ...
              {displayedVenues.map((v) => (
                ...
                >
                  ...
                  <span className="font-mono" style={{
                    ...
                    fontWeight: 600,
                    textAlign: 'right',
                    color: v.advantage > 0 ? '#07CA6B' : v.advantage < 0 ? '#E8171F' : '#455A64',
                  }}>
              ...
              {data.venues.length > 15 && !showAll && (
                <div style={{ padding: '16px 24px', textAlign: 'center' }}>
                  <button
                    ...
                    style={{ padding: '8px 20px', border: '1px solid rgba(232,23,31,0.30)', borderRadius: '4px', fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', cursor: 'pointer', background: 'rgba(232,23,31,0.08)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', color: '#E8171F', transition: 'all 0.2s' }}
                  >
        ...
        {/* Empty state */}
        {!selectedNos && !loading && (
          <div style={{ background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.10)', borderRadius: '4px', padding: '64px 32px', textAlign: 'center' }}>
