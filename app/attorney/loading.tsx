        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} style={{
              ...
              borderRadius: '4px', padding: '28px', height: '180px',
            }}>
              <div style={{ height: '18px', width: '60%', background: '#E5EBF0', borderRadius: '4px', marginBottom: '12px' }} />
              <div style={{ height: '14px', width: '90%', background: '#F0F1F2', borderRadius: '4px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '70%', background: '#F0F1F2', borderRadius: '4px' }} />
            </div>
          ))}
        </div>
      </div>
