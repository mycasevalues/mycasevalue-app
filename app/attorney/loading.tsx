        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} style={{
              ...
              <div style={{ height: '18px', width: '60%', background: 'var(--border-default)', borderRadius: '6px', marginBottom: '12px' }} />
              <div style={{ height: '14px', width: '90%', background: 'rgba(255,255,255,0.04)', borderRadius: '6px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '70%', background: 'rgba(255,255,255,0.04)', borderRadius: '6px' }} />
            </div>
          ))}
        </div>
      </div>
