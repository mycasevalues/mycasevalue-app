      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 20px' }}>
        ...
        {error && (
          <div style={{ backgroundColor: 'rgba(204,16,25,0.08)', border: '1px solid #E5E7EB', borderRadius: '12px', padding: '20px 24px', marginBottom: '24px' }}>
            <p style={{ fontSize: '14px', color: '#8B5CF6', margin: 0 }}>{error}</p>
          </div>
        )}
            ...
            <div style={{ display: 'flex', gap: '8px', justifyContent: 'center', marginTop: '24px', flexWrap: 'wrap' }}>
              {states.slice(0, 6).map((s) => (
                <button
                  ...
                  style={{ padding: '8px 16px', border: '1px solid #E5E7EB', borderRadius: '12px', fontSize: '13px', fontWeight: 500, cursor: 'pointer', background: '#FAFBFC', color: '#8B5CF6', transition: 'border-color 0.2s' }}
                >
                  {s.label}
                </button>
              ))}
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', gap: '24px', alignItems: 'center', flexShrink: 0 }}>
                        <StatBadge label="Win Rate" value={`${judge.plaintiffWinRate}%`} color={judge.plaintiffWinRate >= 55 ? '#059669' : judge.plaintiffWinRate >= 40 ? '#B86E00' : '#8B5CF6'} />
                      ...
                      <div style={{ padding: '0 24px 24px', borderTop: '1px solid #E5E7EB' }}>
                        <div style={{ paddingTop: '20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                          ...
                          <div>
                            ...
                            <MeterBar value={judge.dismissalRate} max={100} color="#8B5CF6" label="Dismissal Rate" />
