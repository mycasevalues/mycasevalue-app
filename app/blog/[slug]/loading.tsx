        ...
        <div style={{
          ...
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} style={{ marginBottom: i === 5 ? 0 : '24px' }}>
              <div style={{ height: '14px', width: '100%', background: '#E5E7EB', borderRadius: '12px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '100%', background: '#E5E7EB', borderRadius: '12px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '95%', background: '#E5E7EB', borderRadius: '12px', marginBottom: '8px' }} />
