export default function BlogPostLoading() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surf)', fontFamily: 'var(--font-ui)' }}>
      ...
      <div style={{ background: 'var(--card)', padding: '40px 24px', borderBottom: '3px solid var(--link)' }}>
        ...
        <div style={{
          ...
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} style={{ marginBottom: i === 5 ? 0 : '24px' }}>
              <div style={{ height: '14px', width: '100%', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '100%', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '8px' }} />
              <div style={{ height: '14px', width: '95%', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '8px' }} />
