    ...
    <div className="min-h-screen" style={{ background: 'var(--surf)' }}>
      ...
      <div className="border-b" style={{ borderColor: 'var(--bdr)', background: 'var(--link)' }}>
        <div className="max-w-5xl mx-auto px-6 py-16 sm:py-24">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 text-[11px] tracking-[1.5px] uppercase mb-4 animate-pulse"
 style={{ background: 'rgba(239,68,68,0.08)', color: 'var(--link)', borderRadius: '3px', fontWeight: 700 }}>
