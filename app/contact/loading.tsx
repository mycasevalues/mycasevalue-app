    ...
    <div style={{ minHeight: '100vh', background: '#F7F8FA' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px' }}>
        <div style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: '6px', padding: '32px' }}>
          <div style={{ height: '24px', width: '200px', background: '#E5E7EB', borderRadius: '6px', marginBottom: '24px' }} />
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #E5E7EB', borderRadius: '6px' }} />
            <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #E5E7EB', borderRadius: '6px' }} />
          </div>
          <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #E5E7EB', borderRadius: '6px', marginBottom: '16px' }} />
          <div style={{ height: '140px', background: '#FAFBFC', border: '1px solid #E5E7EB', borderRadius: '6px', marginBottom: '16px' }} />
