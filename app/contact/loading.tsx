    ...
    <div style={{ minHeight: '100vh', background: '#F5F6F7' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px' }}>
        <div style={{ background: '#FFFFFF', border: '1px solid #D5D8DC', borderRadius: '2px', padding: '32px' }}>
          <div style={{ height: '24px', width: '200px', background: '#E5EBF0', borderRadius: '2px', marginBottom: '24px' }} />
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #D5D8DC', borderRadius: '2px' }} />
            <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #D5D8DC', borderRadius: '2px' }} />
          </div>
          <div style={{ height: '48px', background: '#FAFBFC', border: '1px solid #D5D8DC', borderRadius: '2px', marginBottom: '16px' }} />
          <div style={{ height: '140px', background: '#FAFBFC', border: '1px solid #D5D8DC', borderRadius: '2px', marginBottom: '16px' }} />
