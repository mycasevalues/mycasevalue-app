...
export default function OddsPage() {
  ...
  const winColor = wrColors?.text || 'var(--color-text-primary)';
  ...
  return (
    <>
      <style>{`
        ...
        .odds-link { color: var(--accent-primary-hover); text-decoration: none; transition: color 0.2s ease; }
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(16px, 4vw, 48px)' }}>
          ...
          <span style={{ color: 'var(--color-text-primary)', fontWeight: 600 }}>Check My Odds</span>
        </div>
      </nav>
          ...
          <div className="odds-card" style={{ padding: 'clamp(16px, 3vw, 24px)', marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'end', gap: 16, flexWrap: 'wrap' }}>
              <div>
                ...
                <div style={{ display: 'flex', gap: 0, borderRadius: '4px', overflow: 'hidden', border: '1px solid var(--border-default)' }}>
                  <button
                    type="button"
          ...
          {showResults && results && (
            <div style={{ display: 'grid', gap: 24 }}>
              ...
              <div className="odds-card" style={{
                ...
                textAlign: 'center',
                background: wrColors?.bg || 'var(--color-surface-0)',
                ...
                <p style={{ fontSize: 14, color: 'var(--color-text-secondary)', margin: '0 0 16px' }}>
                  Based on <strong style={{ color: 'var(--color-text-primary)', fontFamily: 'var(--font-mono)' }}>
                ...
                <div style={{
                  ...
                  <span>
                    ...
                    <strong style={{ color: 'var(--wrn-txt, #7A5800)', fontFamily: 'var(--font-mono)' }}>{results.settlementRate.toFixed(1)}%</strong>
                  </span>
                  <span style={{ color: 'var(--border-default)' }}>|</span>
                  <span>
                    <span style={{ color: 'var(--color-text-secondary)' }}>Dismissal: </span>
                    <strong style={{ color: 'var(--accent-primary)', fontFamily: 'var(--font-mono)' }}>{results.dismissalRate.toFixed(1)}%</strong>
                  </span>
                  <span style={{ color: 'var(--border-default)' }}>|</span>
                  <span>
                    <span style={{ color: 'var(--color-text-secondary)' }}>Duration: </span>
                    <strong style={{ color: 'var(--accent-primary-hover)', fontFamily: 'var(--font-mono)' }}>{results.medianDuration} mo</strong>
                  </span>
                </div>
              </div>
                    ...
                    <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #F0F3F5' }}>
                      ...
                      {results.ends.slice(0, 6).map((end, i) => (
                        <div key={i} style={{
                          ...
                          padding: '6px 0',
                          borderBottom: i < Math.min(results.ends.length, 6) - 1 ? '1px solid var(--color-surface-1)' : 'none',
                          fontSize: 12,
                        }}>
                          <span style={{ color: 'var(--color-text-secondary)' }}>{end.label}</span>
                          <span style={{
                            color: end.color || 'var(--color-text-primary)',
                            fontWeight: 600,
                            fontFamily: 'var(--font-mono)',
                          }}>
                ...
                <div className="odds-card" style={{ padding: 'clamp(24px, 4vw, 32px)' }}>
                    ...
                    <>
                      ...
                      <div style={{ position: 'relative', height: 12, borderRadius: 2, overflow: 'hidden', marginBottom: 8 }}>
                        <div style={{
                          width: '100%',
                          height: '100%',
                          background: 'linear-gradient(to right, var(--border-default) 0%, var(--accent-primary-hover) 50%, var(--accent-primary) 100%)',
                          borderRadius: 2,
                        }} />
                      </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                      ...
                      <span style={{ fontSize: 14, color: 'var(--color-text-secondary)' }}>months (median)</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="odds-card" style={{ padding: 'clamp(24px, 4vw, 32px)' }}>
                  ...
                  <div className="odds-grid-3" style={{
                    ...
                    {topCircuits.map(({ circuit, rate }) => {
                      const color = rate >= 50 ? 'var(--data-positive, #176438)' : rate >= 35 ? 'var(--wrn-txt, #7A5800)' : 'var(--accent-primary)';
                      return (
                  ...
                  {Object.keys(results.circuitRates).length > 6 && (
                    <p style={{ fontSize: 12, color: 'var(--color-text-secondary)', margin: '12px 0 0', textAlign: 'right' }}>
              ...
              <div className="odds-card" style={{ padding: 'clamp(24px, 4vw, 32px)' }}>
                <p style={{
                  ...
                  However, <strong style={{ color: 'var(--wrn-txt, #7A5800)' }}>{results.settlementRate.toFixed(1)}%</strong> of
                  cases settle before trial
                  {results.recoveryMedian !== null && (
                    <>, with a median recovery of <strong style={{ color: 'var(--accent-primary-hover)' }}>{fmtK(results.recoveryMedian)}</strong></>
                  )}.
                      ...
                      <div style={{ marginBottom: 8 }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                          ...
                          <span style={{
                            fontSize: 13,
                            fontWeight: 600,
                            color: nationalAverageWinRate >= 50 ? 'var(--data-positive, #176438)' : nationalAverageWinRate >= 35 ? 'var(--wrn-txt, #7A5800)' : 'var(--accent-primary)',
                            fontFamily: 'var(--font-mono)',
                          }}>
                        ...
                        <div style={{ height: 8, background: 'rgba(255,255,255,0.06)', borderRadius: 2, overflow: 'hidden' }}>
                          <div style={{
                            ...
                            background: nationalAverageWinRate >= 50 ? 'var(--data-positive, #176438)' : nationalAverageWinRate >= 35 ? 'var(--wrn-txt, #7A5800)' : 'var(--accent-primary)',
                            borderRadius: 2,
                          }} />
                        </div>
                      </div>
                        ...
                        {factors.map((factor, i) => (
                          <div key={i} style={{ display: 'flex', gap: 12 }}>
                            <div style={{
                              ...
                              height: 8,
                              borderRadius: '50%',
                              background: factor.severity === 'high' ? 'var(--accent-primary)' : 'var(--wrn-txt, #7A5800)',
                              flexShrink: 0,
                              marginTop: 6,
                            }} />
                            <div>
              ...
              {attyData && (
                <section className="odds-card" style={{ padding: 'clamp(24px, 4vw, 32px)' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
                    <div style={{ padding: 24, background: 'rgba(34,197,94,0.1)', border: '1px solid var(--data-positive, #176438)', borderRadius: 4, textAlign: 'center' }}>
                    ...
                    <div style={{ padding: 24, background: 'rgba(239,68,68,0.06)', border: '1px solid var(--data-negative, #B01E1E)', borderRadius: 4, textAlign: 'center' }}>
                  ...
                  {['442', '350', '360', '362', '440', '870', '830', '710', '190', '365'].map(nos => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span style={{
                          color: (rd.wr ?? 0) >= 50 ? 'var(--data-positive, #176438)' : 'var(--accent-primary)',
                          fontWeight: 600,
                          fontFamily: 'var(--font-mono)',
                          fontSize: 12,
                        }}>
