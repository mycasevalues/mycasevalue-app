export default function CalculatorLoading() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surf, #FFFFFF)' }}>
      {/* Header skeleton */}
      <div style={{ background: 'var(--chrome-bg, #1B2D45)', padding: '48px 24px', borderBottom: '1px solid var(--bdr, #E5E7EB)' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px' }}>
        <div style={{ background: '#fff', border: '1px solid var(--bdr, #E5E7EB)', borderRadius: '4px', padding: '32px' }}>
          {[1, 2, 3, 4].map(i => (
            <div key={i} style={{ marginBottom: '24px' }}>
              <div style={{ height: '14px', width: '120px', background: 'var(--bdr, #E5E7EB)', borderRadius: '4px', marginBottom: '8px' }} />
              <div style={{ height: '48px', background: 'var(--surf, #FFFFFF)', border: '1px solid var(--bdr, #E5E7EB)', borderRadius: '4px' }} />
            </div>
          ))}
