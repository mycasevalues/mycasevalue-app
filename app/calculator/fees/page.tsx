      ...
      <div style={{ background: 'var(--color-surface-1)', minHeight: '60vh', padding: 'clamp(24px, 5vw, 48px) clamp(16px, 4vw, 48px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ background: 'var(--color-surface-0)', border: '1px solid var(--border-default)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <h2 style={{ fontSize: 20, fontWeight: 600, color: 'var(--color-text-primary)', margin: '0 0 20px', fontFamily: 'var(--font-ui)' }}>
              Court Filing Fees
            </h2>
            ...
            <div style={{ marginTop: 16, fontSize: 12, color: 'var(--color-text-secondary)', fontFamily: 'var(--font-ui)' }}>
              Source:{' '}
          ...
          <div style={{ background: 'var(--color-surface-0)', border: '1px solid var(--border-default)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--color-text-secondary)', margin: '16px 0 0', fontFamily: 'var(--font-ui)' }}>
          ...
          <div style={{ background: 'var(--color-surface-0)', border: '1px solid var(--border-default)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--color-text-primary)', margin: '0 0 16px', lineHeight: 1.7, fontFamily: 'var(--font-ui)' }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--color-text-secondary)', margin: '16px 0 0', lineHeight: 1.6, fontFamily: 'var(--font-ui)' }}>
