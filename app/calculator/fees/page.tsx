    ...
    <>
      ...
      <main style={{ background: '#F7F8FA', minHeight: '60vh', padding: 'clamp(24px, 5vw, 48px) clamp(16px, 4vw, 48px)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          {/* Filing Fees */}
          <div style={{ background: '#FFF', border: '1px solid #E5E7EB', borderRadius: 12, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <h2 style={{ fontSize: 18, fontWeight: 600, color: '#0f0f0f', margin: '0 0 20px', fontFamily: 'var(--font-display)' }}>
              Court Filing Fees
            </h2>
            <div style={{ display: 'grid', gap: 12 }}>
              {FILING_FEES.map((fee, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px', background: '#FAFBFC', borderRadius: 10, border: '1px solid #E5E7EB', flexWrap: 'wrap', gap: 8 }}>
                  <div style={{ flex: 1, minWidth: 200 }}>
                    <div style={{ fontSize: 15, fontWeight: 600, color: '#0f0f0f', fontFamily: 'var(--font-display)', marginBottom: 2 }}>
                      {fee.label}
                    </div>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              {PACER_FEES.map((fee, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px', background: '#FAFBFC', borderRadius: 10, border: '1px solid #E5E7EB', flexWrap: 'wrap', gap: 8 }}>
                  ...
                  <div style={{ fontSize: 18, fontWeight: 600, color: '#004182', fontFamily: 'var(--font-mono)', whiteSpace: 'nowrap' }}>
                    {fee.amount}
                  </div>
                </div>
              ))}
          ...
          {/* Pro Hac Vice */}
          <div style={{ background: '#FFF', border: '1px solid #E5E7EB', borderRadius: 12, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <h2 style={{ fontSize: 18, fontWeight: 600, color: '#0f0f0f', margin: '0 0 8px', fontFamily: 'var(--font-display)' }}>
              Pro Hac Vice Admission Fees
            </h2>
            <p style={{ fontSize: 13, color: '#4B5563', margin: '0 0 20px', fontFamily: 'var(--font-body)', lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 10 }}>
              {PRO_HAC_VICE.map((d, i) => (
                <div key={i} style={{ padding: '14px 18px', background: '#FAFBFC', borderRadius: 10, border: '1px solid #E5E7EB', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 12, color: '#4B5563', margin: '14px 0 0', fontFamily: 'var(--font-body)' }}>
          ...
          <div style={{ background: '#FFF', border: '1px solid #E5E7EB', borderRadius: 12, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <h2 style={{ fontSize: 18, fontWeight: 600, color: '#0f0f0f', margin: 0, fontFamily: 'var(--font-display)' }}>
                Fee Waiver (In Forma Pauperis)
              </h2>
            </div>

            <p style={{ fontSize: 14, color: '#0f0f0f', margin: '0 0 16px', lineHeight: 1.7, fontFamily: 'var(--font-body)' }}>
            ...
            <div style={{ background: '#EDF3FB', borderRadius: 10, padding: '20px 24px', marginBottom: 16 }}>
              <h3 style={{ fontSize: 14, fontWeight: 600, color: '#004182', margin: '0 0 12px', fontFamily: 'var(--font-display)' }}>
                General Eligibility Guidelines
              </h3>
              <div style={{ fontSize: 13, color: '#0f0f0f', lineHeight: 1.8, fontFamily: 'var(--font-body)' }}>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              <a
                ...
                style={{
                  ...
                  textDecoration: 'none', color: '#0f0f0f', transition: 'border-color 0.2s',
                }}
              >
            ...
            <p style={{ fontSize: 12, color: '#4B5563', margin: '14px 0 0', lineHeight: 1.6, fontFamily: 'var(--font-body)' }}>
