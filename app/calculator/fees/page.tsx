    ...
    <>
      ...
      <nav style={{ background: 'var(--card)', padding: '12px 0', borderBottom: '1px solid var(--bdr)', fontSize: 14, fontFamily: 'var(--font-ui)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(16px, 4vw, 48px)' }}>
          ...
          <span style={{ color: 'var(--bdr)', margin: '0 8px' }}>/</span>
          <span style={{ color: 'var(--text1)', fontWeight: 600 }}>Fee Schedule</span>
        </div>
      </nav>
      ...
      <div style={{ background: 'var(--surf)', minHeight: '60vh', padding: 'clamp(24px, 5vw, 48px) clamp(16px, 4vw, 48px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          {/* Filing Fees */}
          <div style={{ background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <h2 style={{ fontSize: 20, fontWeight: 600, color: 'var(--text1)', margin: '0 0 20px', fontFamily: 'var(--font-ui)' }}>
              Court Filing Fees
            </h2>
            <div style={{ display: 'grid', gap: 12 }}>
              {FILING_FEES.map((fee, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', background: 'var(--surf)', borderRadius: 4, border: '1px solid var(--bdr)', flexWrap: 'wrap', gap: 8 }}>
                  <div style={{ flex: 1, minWidth: 200 }}>
                    <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--text1)', fontFamily: 'var(--font-ui)', marginBottom: 2 }}>
                      {fee.label}
                    </div>
                    <div style={{ fontSize: 12, color: 'var(--text2)', fontFamily: 'var(--font-ui)' }}>
                      {fee.note}
                    </div>
                    <div style={{ fontSize: 12, color: 'var(--link)', fontFamily: 'var(--font-mono)', marginTop: 2 }}>
                      {fee.rule}
                    </div>
                  </div>
                  <div style={{ fontSize: 22, fontWeight: 600, color: 'var(--link)', fontFamily: 'var(--font-mono)', whiteSpace: 'nowrap' }}>
                    {fee.amount}
                  </div>
                </div>
              ))}
            </div>
            <div style={{ marginTop: 16, fontSize: 12, color: 'var(--text2)', fontFamily: 'var(--font-ui)' }}>
              Source:{' '}
              <a href="https://www.uscourts.gov/services-forms/fees/district-court-miscellaneous-fee-schedule" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--link)', textDecoration: 'underline' }}>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              {PACER_FEES.map((fee, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', background: 'var(--surf)', borderRadius: 4, border: '1px solid var(--bdr)', flexWrap: 'wrap', gap: 8 }}>
                  ...
                  <div style={{ fontSize: 18, fontWeight: 600, color: 'var(--gold)', fontFamily: 'var(--font-mono)', whiteSpace: 'nowrap' }}>
                    {fee.amount}
                  </div>
                </div>
              ))}
          ...
          {/* Pro Hac Vice */}
          <div style={{ background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <h2 style={{ fontSize: 18, fontWeight: 600, color: 'var(--text1)', margin: '0 0 8px', fontFamily: 'var(--font-ui)' }}>
              Pro Hac Vice Admission Fees
            </h2>
            <p style={{ fontSize: 14, color: 'var(--text2)', margin: '0 0 20px', fontFamily: 'var(--font-ui)', lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 8 }}>
              {PRO_HAC_VICE.map((d, i) => (
                <div key={i} style={{ padding: '16px 16px', background: 'var(--surf)', borderRadius: 4, border: '1px solid var(--bdr)', textAlign: 'center' }}>
                  <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--text2)', fontFamily: 'var(--font-ui)', marginBottom: 4 }}>
                    {d.district}
                  </div>
            ...
            <p style={{ fontSize: 12, color: 'var(--text2)', margin: '16px 0 0', fontFamily: 'var(--font-ui)' }}>
          ...
          <div style={{ background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: 4, padding: 'clamp(24px, 4vw, 40px)', marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              ...
              <h2 style={{ fontSize: 18, fontWeight: 600, color: 'var(--text1)', margin: 0, fontFamily: 'var(--font-ui)' }}>
                Fee Waiver (In Forma Pauperis)
              </h2>
            </div>

            <p style={{ fontSize: 14, color: 'var(--text1)', margin: '0 0 16px', lineHeight: 1.7, fontFamily: 'var(--font-ui)' }}>
            ...
            <div style={{ background: 'rgba(10,80,162,0.08)', borderRadius: 4, padding: '24px 24px', marginBottom: 16 }}>
              <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--gold)', margin: '0 0 12px', fontFamily: 'var(--font-ui)' }}>
                General Eligibility Guidelines
              </h3>
              <div style={{ fontSize: 14, color: 'var(--text1)', lineHeight: 1.8, fontFamily: 'var(--font-ui)' }}>
            ...
            <div style={{ display: 'grid', gap: 8 }}>
              <a
                ...
                style={{
                  ...
                  background: 'var(--surf)', border: '1px solid var(--bdr)', borderRadius: 4,
                  textDecoration: 'none', color: 'var(--text1)', transition: 'border-color 200ms',
                }}
              >
                <span style={{ fontSize: 14, fontWeight: 600, fontFamily: 'var(--font-ui)' }}>
                  AO 239 — Application to Proceed Without Prepaying Fees
                </span>
                <span style={{ marginLeft: 'auto', fontSize: 12, color: 'var(--link)', fontFamily: 'var(--font-mono)', whiteSpace: 'nowrap' }}>
                  uscourts.gov &rarr;
                </span>
              </a>
              <a
            ...
            <p style={{ fontSize: 12, color: 'var(--text2)', margin: '16px 0 0', lineHeight: 1.6, fontFamily: 'var(--font-ui)' }}>
