    ...
    <div style={{ minHeight: '100vh', background: 'var(--surf, #F6F5F2)', fontFamily: 'var(--font-ui)' }}>
      ...
      <div style={{ background: 'var(--card)', padding: '48px 24px', borderBottom: '1px solid var(--bdr)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ height: '14px', width: '100px', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '16px' }} />
          <div style={{ height: '42px', width: '50%', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '12px' }} />
