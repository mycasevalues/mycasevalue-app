        ...
        <div style={{
          ...
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} style={{
              ...
              <div style={{ height: '20px', width: '75%', background: '#E5E7EB', borderRadius: '2px', marginBottom: '16px' }} />
              ...
              <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid #E5E7EB' }}>
                <div style={{ height: '12px', width: '60%', background: '#E5E7EB', borderRadius: '2px', marginBottom: '6px' }} />
