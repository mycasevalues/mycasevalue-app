  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F6F7', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ height: '14px', width: '200px', background: '#E5EBF0', borderRadius: '4px', marginBottom: '24px' }} />
        {[1, 2, 3, 4, 5].map(i => (
          <div key={i} style={{
            background: '#FFFFFF', border: '1px solid #D5D8DC', borderRadius: '4px',
            padding: '20px', marginBottom: '12px',
          }}>
            <div style={{ height: '18px', width: '60%', background: '#E5EBF0', borderRadius: '4px', marginBottom: '8px' }} />
            <div style={{ height: '14px', width: '80%', background: '#F0F1F2', borderRadius: '4px' }} />
          </div>
        ))}
      </div>
    </div>
