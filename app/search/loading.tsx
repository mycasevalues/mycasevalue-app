  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surf)', fontFamily: 'var(--font-ui)' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ height: '14px', width: '200px', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '24px' }} />
        {[1, 2, 3, 4, 5].map(i => (
          <div key={i} style={{
            background: 'var(--card)', border: '1px solid var(--bdr)', borderRadius: '4px',
            padding: '24px', marginBottom: '12px',
          }}>
            <div style={{ height: '18px', width: '60%', background: 'var(--bdr)', borderRadius: '4px', marginBottom: '8px' }} />
