      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 border text-center" style={{ borderColor: '#D5D8DC', background: '#FFFFFF', borderRadius: '2px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: '#E8171F' }}>5.1M+</div>
              <p className="text-sm" style={{ color: '#455A64' }}>Casos federales analizados</p>
            </div>

            <div className="p-6 border text-center" style={{ borderColor: '#D5D8DC', background: '#FFFFFF', borderRadius: '2px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: '#006997' }}>84</div>
              <p className="text-sm" style={{ color: '#455A64' }}>Tipos de casos cubiertos</p>
            </div>

            <div className="p-6 border text-center" style={{ borderColor: '#D5D8DC', background: '#FFFFFF', borderRadius: '2px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: '#E8171F' }}>94</div>
              <p className="text-sm" style={{ color: '#455A64' }}>Distritos federales</p>
            </div>

            <div className="p-6 border text-center" style={{ borderColor: '#D5D8DC', background: '#FFFFFF', borderRadius: '2px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: '#006997' }}>Gratis</div>
              <p className="text-sm" style={{ color: '#455A64' }}>Durante el lanzamiento</p>
            </div>
          </div>
        </section>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-12 p-6 text-center" style={{ background: '#F5F6F7', borderRadius: '2px' }}>
            <p className="text-sm" style={{ color: '#455A64' }}>
              This page is also available in <Link href="/trends" style={{ color: '#006997', fontWeight: '500', textDecoration: 'none' }} className="hover:underline">English</Link>
            </p>
          </div>
        </div>
      </div>
