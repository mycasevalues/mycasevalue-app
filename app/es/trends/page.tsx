  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-surface-1)' }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="text-center p-8 border" style={{ borderColor: 'var(--border-default)', background: 'var(--color-surface-0)', borderRadius: '12px' }}>
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 border text-center" style={{ borderColor: 'var(--border-default)', background: 'var(--color-surface-0)', borderRadius: '12px' }}>
            ...
            <div className="p-6 border text-center" style={{ borderColor: 'var(--border-default)', background: 'var(--color-surface-0)', borderRadius: '12px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: 'var(--accent-primary-hover)' }}>84</div>
            ...
            <div className="p-6 border text-center" style={{ borderColor: 'var(--border-default)', background: 'var(--color-surface-0)', borderRadius: '12px' }}>
              <div className="text-3xl font-bold mb-2" style={{ color: 'var(--accent-primary-hover)' }}>Gratis</div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-12 p-6 text-center" style={{ background: 'var(--color-surface-1)', borderRadius: '12px' }}>
            <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
              This page is also available in <Link href="/trends" style={{ color: 'var(--accent-primary-hover)', fontWeight: '500', textDecoration: 'none' }} className="hover:underline">English</Link>
            </p>
          </div>
        </div>
      </div>
