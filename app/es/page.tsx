      ...
      <div style={{ background: '#FFFFFF', borderTop: '1px solid #E5E7EB', padding: '48px 24px' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Buscar Casos */}
            <Link href="/search">
              <div className="p-6 border transition-all hover:shadow-lg hover:border-opacity-100" style={{ borderColor: '#E5E7EB', background: '#FFFFFF', borderRadius: '2px', cursor: 'pointer' }}>
