    ...
    <div className="min-h-screen" style={{ background: '#F7F8FA' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6">
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: '6px', padding: '24px' }}>
        ...
        <div className="mt-12 p-6 text-center" style={{ background: '#F7F8FA', borderRadius: '6px' }}>
          <p className="text-sm" style={{ color: '#4B5563' }}>
            This page is also available in <Link href="/disclaimer" style={{ color: '#6D28D9', fontWeight: '500', textDecoration: 'none' }} className="hover:underline">English</Link>
          </p>
        </div>
      </div>
    </div>
