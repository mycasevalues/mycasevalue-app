  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-surface-1)' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-16 text-center p-8 border" style={{ borderColor: 'var(--border-default)', background: 'var(--color-surface-0)', borderRadius: '12px' }}>
          ...
          <a href="mailto:support@mycasevalues.com"
            ...
            style={{ borderRadius: '12px', background: 'var(--color-surface-0)', border: '1px solid var(--border-default)', color: 'var(--accent-primary-hover)' }}>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12 p-6 text-center" style={{ background: 'var(--color-surface-1)', borderRadius: '12px' }}>
            <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
              This page is also available in <Link href="/faq" style={{ color: 'var(--accent-primary-hover)', fontWeight: '500', textDecoration: 'none' }} className="hover:underline">English</Link>
            </p>
          </div>
        </div>
      </div>
