        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#004182" strokeWidth="2.5" className="flex-shrink-0 mt-1">
          ...
          <div className="border p-8 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/20"
            ...
            <div className="mb-6">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-extrabold" style={{ color: '#004182', fontFamily: 'PT Mono' }}>
                  $29.99
                </span>
                <span className="text-sm" style={{ color: '#4B5563' }}>
                  /mes
      ...
      <div style={{ background: '#FFFFFF', borderTop: '1px solid #E5E7EB', padding: '48px 24px' }}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-12 p-6 text-center" style={{ background: '#F7F8FA', borderRadius: '12px' }}>
            <p className="text-sm" style={{ color: '#4B5563' }}>
              This page is also available in <Link href="/pricing" style={{ color: '#004182', fontWeight: '500', textDecoration: 'none' }} className="hover:underline">English</Link>
            </p>
          </div>
        </div>
      </div>
