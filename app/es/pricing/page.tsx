...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://mycasevalues.com/es/pricing',
    languages: {
      en: 'https://mycasevalues.com/pricing',
      es: 'https://mycasevalues.com/es/pricing',
    },
  },
  openGraph: {
    ...
    type: 'website',
    url: 'https://mycasevalues.com/es/pricing',
    locale: 'es_ES',
  },
};
  ...
  '@graph': [
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Precios', item: 'https://mycasevalues.com/es/pricing' },
      ],
    },
  ],
};
