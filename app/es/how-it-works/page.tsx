    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <section>
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-full" style={{ background: '#1856FF', color: 'white' }}>
              ...
              <div>
                ...
                <p style={{ color: 'rgba(240,242,245,0.70)' }} className="text-lg leading-relaxed">
        ...
        <section className="mt-16">
          <h2 className="text-3xl font-display font-bold mb-8" style={{ color: '#F0F2F5' }}>
            Principios Clave
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl border" style={{ borderColor: 'var(--border-default)', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(12px)' }}>
              <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4" style={{ background: 'rgba(24, 86, 255, 0.12)' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3D72FF" strokeWidth="2">
        ...
        {/* CTA Section */}
        <section className="mt-16 text-center p-8 rounded-xl border" style={{ borderColor: 'var(--border-default)', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(12px)' }}>
          <h2 className="text-2xl font-display font-bold mb-3" style={{ color: '#F0F2F5' }}>
            Listo para comenzar?
          </h2>
          <p className="mb-6" style={{ color: 'rgba(240,242,245,0.70)' }}>
