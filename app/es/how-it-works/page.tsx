      ...
      <div className="border-b" style={{ background: 'var(--link)', borderColor: 'var(--bdr)' }}>
        <div className="max-w-5xl mx-auto px-6 py-12 sm:py-16">
          ...
          <nav className="flex items-center gap-2 mb-8 text-sm">
            ...
            <span style={{ color: 'var(--card)' }} className="opacity-80">Cómo Funciona</span>
          </nav>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border" style={{ borderColor: 'var(--bdr)', background: 'var(--card)', borderRadius: '4px' }}>
