...
const h1: React.CSSProperties = { color: '#0f0f0f', fontSize: '22px', fontWeight: 600, margin: '0 0 8px' };
const paragraph: React.CSSProperties = { color: '#4B5563', fontSize: '14px', lineHeight: '1.6', margin: '0 0 16px' };
...
const detailsBox: React.CSSProperties = {
  backgroundColor: '#FAFBFC', borderRadius: '8px', border: '1px solid #E5E7EB',
  padding: '16px 20px',
};
